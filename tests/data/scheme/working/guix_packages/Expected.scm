...
(define-public new-package-left
  (package
    (name "new-package-left")
    (version "0.5l")
    (source
      (origin
        (method url-fetch)
        (uri "mirror://gnu/new-package-left/1.5.tgz")
        (sha256 (base32 "hash05l"))))
    (build-system gnu-build-system)
    (arguments (list #:configure-flags #~(list "--enable-frobnicate")))
    (home-page "https://example.com/new-package-left")
    (synopsis "New package")
    (description "New package left")
    (license license:gpl3+)))

(define-public new-package-right
  (package
    (name "new-package-right")
    (version "0.5l")
    (source
      (origin
        (method url-fetch)
        (uri "mirror://gnu/new-package-right/1.5.tgz")
        (sha256 (base32 "hash05l"))))
    (build-system gnu-build-system)
    (arguments (list #:configure-flags #~(list "--enable-frobnicate")))
    (home-page "https://example.com/new-package-right")
    (synopsis "New package")
    (description "New package right")
    (license license:gpl3+)))
