...
mod tests {
    ...
    fn isomorphism_identical_files() {
        assert_eq!(
            real_main(&CliArgs::parse_from([
                "mgf_dev",
                "compare",
                "../tests/data/java/working/demo/Base.java",
                "../tests/data/java/working/demo/Base.java",
            ])),
            Ok(0)
        );
    ...
    fn isomorphism_isomorphic_trees() {
        assert_eq!(
            real_main(&CliArgs::parse_from([
                "mgf_dev",
                "compare",
                "../tests/data/java/working/reformat/Base.java",
                "../tests/data/java/working/reformat/Left.java",
            ])),
            Ok(0)
        );
    }
    ...
    fn isomorphism_different_trees() {
        assert_eq!(
            real_main(&CliArgs::parse_from([
                ...
                "compare",
                "../tests/data/java/working/demo/Base.java",
                "../tests/data/java/working/demo/Left.java",
            ])),
            Ok(1)
        );
    }
    ...
    fn disabled_commutative_isomorphism() {
        assert_eq!(
            real_main(&CliArgs::parse_from([
                "mgf_dev",
                "compare",
                "../tests/data/rust/working/reordering_use_statements/Base.rs",
                "../tests/data/rust/working/reordering_use_statements/Left.rs",
            ])),
            Ok(1)
        );
    }
    ...
    fn set_language() {
        ...
        fs::copy("../tests/data/java/working/demo/Base.java", &test_file)
